...
int main()
{
    ...
    switch(ch)
    {
        ...
        case '2': 
                ...
                cout<<"5. See Borrow on loan location"<<endl;
                cout<<"6. Exit"<<endl;
                ...
                switch(choice)
                {
                    ...
                    case '3':   int choice_loc;
                             ...
                             break;
                    case '4': u.borrow_on_loan();
                              break;
                    case '5': u.b_on_loan_location();
                              break;
